...
public class RegisterActivity extends BaseActivity {
	...
	@ViewInject(R.id.activity_register_item_et_num)
	...
	@ViewInject(R.id.activity_register_item_et_password)
	private EditText registerPassword;
	
	@ViewInject(R.id.activity_register_item_et_referrer_num)
	private EditText registerRefePhoneNum;
	...
	private void onGetRegisterCodeClick(View v) {
		...
		if(CommonUtil.isFastDoubleClick())
			return;
		String phoneNum = registernumEditText.getText().toString();
		...
		params.addBodyParameter("operFlag", "REG");
		...
		https.send(HttpRequest.HttpMethod.POST, Consts.SERVER_URL_USER_GET_SECURITYCODE, params, new RequestCallBack<String>() {
			...
			public void onSuccess(ResponseInfo<String> responseInfo) {
				...
				try {
					...
					if ("0".equals(jsonObject.getString("status"))) {
						...
						EventHandler.showToast(RegisterActivity.this, errMsg);
						return;
					}
					
					if ("1".equals(jsonObject.getString("status"))) {
						closeProgressDialog();
						EventHandler.showToast(RegisterActivity.this, "验证码发送成功！");
					...
					LogUtil.logError(e);
					closeProgressDialog();
					EventHandler.showToast(RegisterActivity.this, "服务器很忙，请稍后重试");
				}
			}
			...
			public void onFailure(HttpException error, String msg) {
				...
				closeProgressDialog();
				EventHandler.showToast(RegisterActivity.this, "服务器忙，请稍后重试");

			}
		});
	}
	
	@OnClick(R.id.activity_register_item_rl_confirm)
	//注册按钮响应
	public void onResgisterButtonClick(View v) {
		...
		https.send(HttpMethod.POST, Consts.SERVER_URL_USER_REGISTER, params, new RequestCallBack<String>() {
			...
			public void onSuccess(ResponseInfo<String> responseInfo) {
				...
				try {
					...
					if("1".equals(jsonObject.getString("status"))) {
						...
						EventHandler.showToast(RegisterActivity.this, "恭喜，注册成功！");
